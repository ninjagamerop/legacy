...
TELEGRAM_BOT_TOKEN = '8058370192:AAGRsGx99nQDTfHFtX6mTI1o3weW4UhAAiM'  # Replace with your bot token
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        "*❄️ WELCOME TO NINJA ULTIMATE UDP FLOODER ❄️*\n\n"
...
async def help(update: Update, context: CallbackContext):
    chat_id = update.effective_chat.id
    message = (
        "*🛠️ NINJA VIP DDOS Bot Help Menu 🛠️*\n\n"
